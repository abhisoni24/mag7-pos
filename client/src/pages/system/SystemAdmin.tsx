...
import { fetchStaff, StaffMember, createStaffMember, updateStaffMember } from '../../redux/staffSlice';
        ...
        <TabsContent value="users">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <div>
                <CardTitle className="text-xl font-bold">System Administrators</CardTitle>
                <CardDescription>Manage system administrators with full access</CardDescription>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Create a backup of the current database</CardDescription>
              </CardHeader>
              <CardContent className="flex justify-center">
                <Button 
                  className="w-full" 
                  onClick={simulateDBBackup}
                >
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Restore the database from a backup</CardDescription>
              </CardHeader>
              <CardContent className="flex justify-center">
                <Button 
                  className="w-full" 
                  onClick={simulateDBRestore}
                >
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Reset the database to its initial state</CardDescription>
              </CardHeader>
              <CardContent className="flex justify-center">
                <Button 
                  variant="destructive" 
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label className="text-sm text-gray-500">Connection String</Label>
                    <div className="font-mono text-sm bg-gray-100 p-2 rounded mt-1 break-all">
                      mongodb+srv://asoni24:admin@cluster0.mpqcvei.mongodb.net/
                    </div>
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <div className="font-mono text-sm bg-green-100 text-green-800 p-2 rounded mt-1">
                      Connected
                    </div>
                  </div>
                  <div>
                  ...
                  <div>
                    <Label className="text-sm text-gray-500">Last Reset</Label>
                    <div className="font-mono text-sm bg-gray-100 p-2 rounded mt-1">
                      Never
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <Select defaultValue="strong">
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="strong">Strong (min 8 chars, numbers, symbols)</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
